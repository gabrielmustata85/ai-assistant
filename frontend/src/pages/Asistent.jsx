  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-6 py-4 border-b border-hairline bg-white">
        <div>
          <h1 className="font-display font-bold text-xl text-ink">Marius</h1>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted mb-4">Sunt Marius. Întreabă-mă orice despre taxele și obligațiile firmei tale.</p>
