...
const ICONS = {
  ...
  colaboratori: <><circle cx="9" cy="8" r="3" /><path d="M3.5 19a5.5 5.5 0 0111 0" /><path d="M16 5.2a3 3 0 010 5.6M21 19a5.5 5.5 0 00-4-5.3" /></>,
...
const NAV = [
  ...
  { to: '/colaboratori', label: 'Colaboratori', icon: 'colaboratori' },
