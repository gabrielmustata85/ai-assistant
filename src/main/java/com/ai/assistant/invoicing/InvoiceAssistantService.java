...
public class InvoiceAssistantService {
    ...
    public InvoiceDraft draft(Long companyId, String instruction) {
        ...
        String prompt = "Te numești Marius, asistentul fiscal. Pregătești o SCHIȚĂ de factură pe care "
                ...
                + "- Linia facturii: dacă userul dă cantitate și preț unitar (ex: „72 ore x 110 lei”), "
                + "completează unit, quantity, unitPrice, iar netAmount = quantity*unitPrice. Dacă dă doar "
                + "o sumă totală, pune quantity=1 și unitPrice=netAmount, unit gol.\n"
